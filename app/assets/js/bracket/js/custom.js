...
jQuery(document).ready(function() {
   ...
   $(document).on("blur", "input:not('.datepicker')", function() {
   ...
   $(document).on("click", ".nav-parent > a", function() {
      ...
      //    "color": "#94989d"
      // });
      // $(this).parent().find(".chactive").eq(0).css({"color":"#1caf9a"});
      // Dropdown works only when leftpanel is not collapsed
      if (!jQuery('body').hasClass('leftpanel-collapsed')) {
         if (sub.is(':visible')) {
            sub.slideUp(200, function() {
               //$(_this).css({"background-image":"url('/build/assets/js/bracket/images/plus.png')"})
               //sub.attr("status", "up");
            ...
            sub.slideDown(200, function() {
               // $(_this).css({
               //    "background-image": "url('/build/assets/js/bracket/images/minus.png')"
               // })
               //$(".children").attr("status", "up");
               //sub.attr("status", "down");
               adjustmainpanelheight();
            });
         }
      }
   ...
   //          t.find('> ul').slideUp(200, function() {
   //             // t.find("a").eq(0).css({
   //             //    "background-image": "url('/build/assets/js/bracket/images/plus-white.png')"
   //             // });
   ...
   $(document).on("mouseover mouseout", ".nav-bracket > li", function(event) {
